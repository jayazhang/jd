    ...
    var g = {
        ...
        init: function () {
            ...
            if (null == a.sGet("amb_jd_open")) {
                var b = "";
                null != a.sGet("amb_jd_open_info") ? (b = a.sGet("amb_jd_open_info")) : (b = a.randomString(), a.sSet(
                    "amb_jd_open_info", b, window.amb_jd_proxy_c));
                a._ajax("//" + window.amb_jd_proxy_domain + "/jsonp/getKey?callback=jsonp" + b, {
                    f: a.id,
                    h: a.hasload,
